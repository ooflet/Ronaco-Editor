--[[
    ...
    - Forked to have compatibility with Kommand. Skid, if you can manage to add these compatibilities onto ur script pls send screenshot to 
    basically a toaster#7699 and i will give
...
--[[
     ...
     K-Ronaco uses propriatary code for Kommand. 
